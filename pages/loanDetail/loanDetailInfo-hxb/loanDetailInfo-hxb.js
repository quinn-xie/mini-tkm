...
Page({
  ...
  loadData() {
    ...
    wx.showLoading({
      ...
      wx.request({
      //url: 'https://qianduan-uat.taikongma.com/mobile/app/loansign/infomation?loanSignId=4767&_APP_VERSION_CODE=10.10.10.10&_DEVICE_IDENTIFIER=IOS-WECHAT-MINI', 
        ...
        success: function (res) {
          //console.log(res.data.data.hxylDetailVo.attachment)
