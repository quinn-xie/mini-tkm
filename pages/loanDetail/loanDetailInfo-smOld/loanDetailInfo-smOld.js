...
Page({
  ...
  loadData() {
    ...
    wx.showLoading({
      ...
      wx.request({
      url: 'https://qianduan-uat.taikongma.com/mobile/app/loansign/infomation?loanSignId=1509&_APP_VERSION_CODE=10.10.10.10&_DEVICE_IDENTIFIER=IOS-WECHAT-MINI',
      //url: 'https://qianduan-uat.taikongma.com/mobile/app/loansign/infomation?loanSignId=' + that.data.loanId +'&_APP_VERSION_CODE=10.10.10.10&_DEVICE_IDENTIFIER=IOS-WECHAT-MINI', //接口地址
        ...
        success: function(res) {
          console.log(res.data.data.shenMaDetailVo)
          that.setData({
            loadDetailInfo: {},
